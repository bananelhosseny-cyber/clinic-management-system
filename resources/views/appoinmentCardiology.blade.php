...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/awesome/6.5.1/css/all.min.css" />
        ...
        <div class="page-wrapper">
            <div class="doctor-card">
                <div class="doctor-image">
                    <img src="{{ asset('images/cardiology Doc.jpg') }}" alt="Doctor Image">
                </div>
            ...
            <form action="{{ url('/appointment/store') }}" method="POST">
                @csrf
                <input type="hidden" name="doctor_id" value="7">
                <div class="patient-form">
                    <div class="form-row">
                        <div class="form-group">
                            <label for="patientSelect">Select Patient</label>
                            <select required id="patientSelect" name="patient_type" class="form-control">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input minlength="11" required type="number" name="phone" id="phoneNumber" class="form-control" placeholder="4545435">
                        </div>
                        <div class="form-group">
