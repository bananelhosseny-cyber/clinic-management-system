...
<body>
    ...
    <section class="page-header">
        <h1>Dr. Mahmoud Ahmed</h1>
    </section>

    <section class="doctor-profile">
        <div class="profile-card">
            <div class="left">
                <img src="{{ asset('images/Orthopedics Doc.jpg') }}">
            </div>
            <div class="middle">
                <h2>Dr. Mahmoud Ahmed <i class="fa fa-check-circle verified"></i></h2>
                <p class="speciality">Orthopedic</p>
                <p><i class="fa fa-user"></i> 1000+ Patients Treated</p>
            ...
            <div class="right">
                ...
                <p><i class="fa fa-phone"></i> 01125708766</p>
                <p><i class="fa fa-money-bill"></i> Consultation Fee: 200 EGP</p>
                <button class="outline">Add Feedback</button>
                <a href="{{ route('orthopedics') }}"><button class="primary">Book Appointment</button></a>
            </div>
        </div>
    </section>
    ...
    <section class="tabs-section">
        ...
        <div class="tab-content active" id="overview">
            <h3>About Dr. Mahmoud Ahmed</h3>
            <p style="font-size: 16px;">
                Dr. Mahmoud Ahmed – Orthopedic Specialist
                Dr. Mahmoud Ahmed is a highly skilled and dedicated Orthopedic Specialist with over 12 years of experience in diagnosing and treating a wide range of musculoskeletal conditions. He is committed to improving patients’ mobility, relieving pain, and enhancing their quality of life through advanced medical techniques and personalized treatment plans.<br><br>
                <span style="color: red; font-size: 18px;">Areas of Expertise:</span><br>
                Joint Replacement Surgery (Knee and Hip)
                Arthroscopic Surgery
                Sports Injuries Treatment
                Fracture Management and Trauma Surgery
                Spine Disorders Treatment
                Pediatric Orthopedics<br><br>
                <span style="color: red; font-size: 18px;">Professional Experience:</span><br>
                Dr. Ahmed has successfully treated thousands of patients, focusing on providing accurate diagnosis, effective treatment, and comprehensive rehabilitation plans. His approach combines the latest orthopedic technologies with compassionate patient care, ensuring faster recovery and long-term results.<br><br>
                <span style="color: red; font-size: 18px;">Education & Certifications:</span><br>
                Bachelor of Medicine and Surgery (MBBS)
                Master’s Degree in Orthopedic Surgery
                Specialized training in Joint Replacement and Arthroscopy
                Member of the Egyptian Orthopedic Association<br><br>

                <span style="color: red; font-size: 18px;">Professional Skills:</span><br>
                Accurate clinical assessment and diagnosis
                Advanced surgical skills in orthopedic procedures
                Patient education and post-surgery rehabilitation planning
                Team leadership in surgical and clinical settings<br><br>

                <span style="color: red; font-size: 18px;">Achievements:</span><br>
                Recognized for excellence in joint replacement surgeries
                Participated in national and international orthopedic conferences
                Conducted workshops on sports injury prevention and rehabilitation
                Contributed to medical research and publications in orthopedic journals<br><br>

                <span style="color: red; font-size: 18px;">Personal Philosophy:</span><br>
                Dr. Mahmoud Ahmed believes in combining precision, innovation, and compassionate care to restore movement and improve patients’ daily lives. He is passionate about helping patients regain strength, mobility, and confidence through comprehensive orthopedic solutions.
            </p>
        </div>
