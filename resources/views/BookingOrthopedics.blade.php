...
<body>
    ...
    {{-- doctor_id = 3 → Mahmoud Ahmed (Orthopedics) --}}
    <form id="bookingForm" action="{{ url('/appointment/3') }}" method="GET" style="display:none;">
    ...
    <div class="booking-page">
        <div class="doctor-card">
            <div class="doctor-main-info">
                <img src="{{ asset('images/Orthopedics Doc.jpg') }}" class="doctor-avatar" alt="Doctor">
                <div class="doctor-text">
                    <h2 class="doctor-name">Dr. Mahmoud Ahmed</h2>
                    <span class="doctor-specialty">Orthopedic Surgeon</span>
                    <p class="doctor-location">Cairo, Egypt</p>
                </div>
            </div>
    ...
    <script src="{{ asset('Java/BookingOrthopedics.js') }}"></script>
