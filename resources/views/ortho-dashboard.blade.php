...
<head>
    ...
    <link rel="stylesheet" href="CSS/Ortho  Dashboard.css" />
</head>
...
<body>
    ...
    <aside class="left-nav-sidebar">
        ...
        <div class="left-nav-logo-section">
            ...
            <div class="left-nav-logo-text">
                <div class="left-nav-app-name">Dr. Mahmoud Ahmed</div>
                <div class="left-nav-app-subtitle">Orthopedic</div>
            </div>
        </div>

        <nav class="left-nav-links-wrapper">
            <div class="left-nav-link active" onclick="navigate('appt', this)">
    ...
    <main class="main-content-area">
        ...
        <div class="page-section active" id="page-appt">
    ...
    <script>
        ...
        window.DOCTOR_PASSWORD = "MahmoudAhmed3";
    </script>
    <script src="https://cdn.jsdelivr.net/npm/jspdf@2.5.1/dist/jspdf.umd.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/jspdf-autotable@3.5.31/dist/jspdf.plugin.autotable.min.js"></script>
    <script src="Java/Ortho Dashboard.js"></script>
</body>
