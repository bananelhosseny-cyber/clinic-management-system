...
<head>
    ...
    <link rel="stylesheet" href="CSS/Cardiology  Dashboard.css" />
</head>

<body>
    <aside class="left-nav-sidebar">

        <!-- App logo + name at the top of sidebar -->
        <div class="left-nav-logo-section">
            <div class="left-nav-logo-icon">M</div>
            <div class="left-nav-logo-text">
                <div class="left-nav-app-name">Dr. John Smith</div>
                <div class="left-nav-app-subtitle">Cardiologist</div>
            </div>
        </div>
    ...
    <script>
        ...
        window.DOCTOR_PASSWORD = "JohnSmith1";
    </script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.31/jspdf.plugin.autotable.min.js"></script>
    <script src="Java/Cardiology  Dashboard.js"></script>
</body>
