...
<body>
    ...
    <form id="bookingForm" action="{{ url('/appointment/2') }}" method="GET" style="display:none;">
    ...
    <div class="booking-page">
        <div class="doctor-card">
            <div class="doctor-main-info">
                <img src="{{ asset('images/cardiology Doc.jpg') }}" class="doctor-avatar" alt="Doctor">
    ...
    <script src="{{ asset('Java/BookingCardiology.js') }}"></script>
